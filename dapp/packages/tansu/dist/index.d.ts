...
export interface Client {
     ...
     */
    add_member: ({ member_address, meta, git_identity, git_pubkey, git_sig }: {
     ...
     * * If the signature verification fails
     */
    update_member: ({ member_address, meta, git_identity, git_pubkey, git_sig }: {
        member_address: string;
        meta: string;
        git_identity: Option<string>;
        git_pubkey: Option<Buffer>;
     ...
     * * If the contract i
     */
    attest: ({ attester, project_key, commit_hash, target, note }: {
        attester: string;
        project_key: Buffer;
        commit_hash: string;
     ...
     * *
     */
    register: ({ maintainer, name, maintainers, url, ipfs, min_voting_period, execute_delay, attestation_threshold }: {
        maintainer: string;
        name: string;
        maintainers: Array<string>;
        url: string;
    ...
    get_evidence: ({ project_key, commit_hash, kind }: {
        ...
        commit_hash: string;
        kind: EvidenceKind;
    }, options?: MethodOptions) => Promise<AssembledTransaction<Array<Evidence>>>;
    /**
     ...
     * * If cid is empty
     */
    set_evidence: ({ maintainer, project_key, commit_hash, kind, cid }: {
        maintainer: string;
        project_key: Buffer;
        commit_hash: string;
        kind: EvidenceKind;
     ...
     * *
     */
    update_config: ({ maintainer, key, maintainers, url, ipfs, min_voting_period, execute_delay, attestation_threshold }: {
        maintainer: string;
        key: Buffer;
        maintainers: Array<string>;
        url: string;
     ...
     */
    revoke_attestation: ({ attester, project_key, commit_hash, target }: {
        attester: string;
        project_key: Buffer;
        commit_hash: string;
        target: AttestationTarget;
    ...
    get_attestation_finality: ({ project_key, commit_hash, target }: {
        ...
        commit_hash: string;
        target: AttestationTarget;
    }, options?: MethodOptions) => Promise<AssembledTransaction<FinalityStatus>>;
    /**
     ...
     */
    get_attestation_threshold: ({ project_key }: {
        project_key: Buffer;
    }, options?: MethodOptions) => Promise<AssembledTransaction<u32>>;
    /**
     ...
     */
    set_attestation_threshold: ({ maintainer, project_key, attestation_threshold }: {
        maintainer: string;
        project_key: Buffer;
        attestation_threshold: Option<u32>;
    }, options?: MethodOptions) => Promise<AssembledTransaction<null>>;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        revoke_attestation: (json: string) => AssembledTransaction<null>;
        get_attestation_finality: (json: string) => AssembledTransaction<FinalityStatus>;
